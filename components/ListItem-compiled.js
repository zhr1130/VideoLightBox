...
{
return(
_react2.default.createElement(_reactNative.TouchableOpacity,{onPress:this._onPressButton.bind(this)},
_react2.default.createElement(_reactNative.View,{style:{flexDirection:'row',height:100,padding:20}},
_react2.default.createElement(_reactNative.Image,{source:{uri:this.props.item.metadata.image.imageUrl},style:{width:100,height:70}}),
_react2.default.createElement(_reactNative.View,{style:{flexDirection:'column'}},
_react2.default.createElement(_reactNative.Text,null,this.props.item.metadata.title),
_react2.default.createElement(_reactNative.Text,null,'By ',this.props.item.metadata.vendorName),
_react2.default.createElement(_reactNative.Text,null,this.props.item.metadata.runtime)))));




}},{key:'_onPressButton',value:function _onPressButton()
...
//# sourceMappingURL=ListItem-compiled.js.map